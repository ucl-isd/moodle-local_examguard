...
$string['error:cannot_hide_exam_activity'] = 'This activity cannot be hidden because Exam Guard treats it as an exam activity (it has a short scheduled duration). Exam Guard will lock course editing before the exam starts, which would prevent you from making it visible again.';
$string['error:cannot_hide_exam_activity_title'] = 'Cannot hide exam activity';
...
$string['error:failed_to_save_override'] = 'Failed to save override.';
...
$string['error:original_user_override_data_empty'] = 'Original user override data is empty.';
...
$string['warning:hidden_exam_activity'] = 'Warning: This activity is hidden but Exam Guard treats it as an exam activity. Exam Guard will lock course editing before the exam starts, which would prevent you from making it visible again.';
$string['warning:hide_without_times'] = 'We recommend that you set an open and close time instead of manually relying on hiding and revealing the quiz at the start of the exam. This can lead to severe performance disruption during the exam so we strongly encourage you to use the open and close time.';
